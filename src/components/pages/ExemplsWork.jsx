      ...
      <div className="exempls-work-page">
        <section className="services-header">
          <div className="container">
            ...
            <p>Наша автомайстерня - це сімейний бізнес, тому ми робимо все як для себе. Якісно. Надовго. Без переплат. Подивіться на зразки наших виконаних робіт, щоб бути упевненим у надійності наших спеціалістів, в руки яких ви передаєте свій автомобіль.</p>
          </div>
        </section>
